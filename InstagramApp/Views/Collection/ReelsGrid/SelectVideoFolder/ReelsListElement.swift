...
#Preview {
    ReelsListElement(folderIndex: 0, reelsViewModel: ReelsViewModel(), folder: ReelsFolderModel(reelsArray: [mockReelsResponse.data.reels], name: ""), selectedFolderIndex: .constant(0))
}
